...
const GPSTracker = ({
  ...
  return <Card className="p-4 rounded-2xl shadow-card bg-card/80 backdrop-blur">
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          ...
          {isTracking && <Badge className="bg-comfort text-comfort-foreground">
        ...
        {currentPosition && <div className="space-y-2">
        ...
        {isTracking && !currentPosition && !error && <div className="p-4 text-center">
